...
{
    public sealed class UIRuntimeEntryPointRecoveryTests
    {
        ...
        [Test]
        public void OpenPopup_FailedRequestAfterDestroyedBlockingOverlay_RestoresScreenInput()
        {
            ...
            Result<UIPopup> failedResult = controller.OpenPopup(
        ...
        [Test]
        public void OpenScreen_FailedRequestAfterDestroyedBlockingOverlay_RestoresCurrentScreenInput()
        {
            UIScreen screen = CreateScreenPrefab(
                "screen.main");
            ...
            Result<UIScreen> failedResult = controller.OpenScreen(
